...
public class PlatformGenerator : MonoBehaviour {
	...
	void Update () {
        ...
        if (transform.position.x < generationPoint.position.x) {
            ...
            platformeSelector = Random.Range(0, theObjectPools.Length);
            ...
            //Instantiate(/*thePlatform*/ thePlatforms[platformeSelector], transform.position, transform.rotation);

            GameObject newPlatform = theObjectPools[platformeSelector].GetPooledObject();
